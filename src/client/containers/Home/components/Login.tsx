...
export const Login: FunctionComponent<LoginProps> = ({ onTokenReceive }) => (
    <Flex fill column gap="gap.small" styles={{ padding: "60px" }}>
        ...
        <Flex fill column gap="gap.medium">
            <Text
                content={
                    "Once proceeding, we will ask you to authorize Microsoft Teams access through a separate " +
                "window. Once it’s authorized, you can do more advanced settings on the Teams channel linked " +
                "with Zeplin."
                }
            />
            <Button
